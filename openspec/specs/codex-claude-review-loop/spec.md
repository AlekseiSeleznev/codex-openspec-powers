# codex-claude-review-loop Specification

## Purpose
Define the optional Claude OpenSpec Review loop, including review controls,
file-scope isolation, budgets, saved review artifacts, blocker handling, and
chat-visible status for gated OpenSpec workflow steps.
